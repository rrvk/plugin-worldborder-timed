...
group = "nl.robertvankammen.worldborder-timed"
version = "0.0.1"
description = "plugin that can change the world border in random times"
...
bukkit {
  ...
  main = "nl.robertvankammen.worldbordertimed.WorldborderPlugin"
  apiVersion = "1.19"
